...
handleChange = (e) => {
    ...
    calculate = () => {
        ...
        this.setState({
          result : Math.round((range-3)*100/12,2)
        })   
    }
    render() {
                 ...
                 <IonCard className="inputcard">
                     <IonCardContent>
                        <div className="row">
                            ...
                            <div class="col-md-10"><input type="range" name="range" min="3" max="15" value={range} class="slider" id="myRange" onChange={this.handleChange}></input>
                            </div>
                        </div>
                        <div className="row">
